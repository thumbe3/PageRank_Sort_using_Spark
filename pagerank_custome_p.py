...
conf = SparkConf().setAppName('modification_3'+sys.argv[1]+'_'+sys.argv[2]).setMaster('spark://'+ ip_addr +':7077')
...
ranks.saveAsTextFile('LeftRanks_Output') #save the RDD in HDFS at /LeftRanks_Output
